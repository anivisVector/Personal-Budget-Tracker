...
def dashboard():
    if 'loggedin' in session:
        ...
        return render_template('dashboard.html', balance=balance, transactions=transactions, total_income=total_income, total_expense=total_expense)
    return redirect(url_for('login'))
...
def analytics():
    ...
    return render_template('analytics.html', monthly_data=monthly_data, category_data=category_data)
